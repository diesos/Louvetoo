...
return (
	...
	icon={<FontAwesomeIcon icon={faChild} style={{fontSize: '2.2em', color: 'pink'}} />}
	title="Gérer les Enfants"
	detail="Ajouter, modifier ou supprimer un enfant"
	color="pink"
	/></Link>
	<Link to='/adminusers'><AdminCards
	icon={<FontAwesomeIcon icon={faUser} style={{fontSize: '2em', color: 'blue'}} />}
	title="Gérer les Utilisateurs"
	detail="Ajouter, modifier ou supprimer un utilisateur"
	color='blue'
	/></Link>
	<Link to='/adminactivite'><AdminCards
		icon={<FontAwesomeIcon icon={faGamepad} style={{fontSize: '2em', color: 'purple'}} />}
